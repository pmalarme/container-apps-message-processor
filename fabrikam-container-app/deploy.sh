...
RESOURCE_GROUP_NAME=${RESOURCE_GROUP_NAME:-"rg-fabrikam-containerapp"}
LOCATION=${LOCATION:-"eastus"}
ENVIRONMENT_NAME=${ENVIRONMENT_NAME:-"test"}

CONTAINER_REGISTRY_NAME=${CONTAINER_REGISTRY_NAME:-"crfabrikamcontainerapp$(cat /dev/urandom | tr -dc 'a-z0-9' | fold -w 5 | head -n 1)"}
CONTAINER_APP_NAME=${CONTAINER_APP_NAME:-"ca-message-processor"}
SERVICE_BUS_NAMESPACE_NAME=${SERVICE_BUS_NAMESPACE_NAME:-"sbns-fabrikam-containerapp$(cat /dev/urandom | tr -dc 'a-z0-9' | fold -w 5 | head -n 1)"}
SERVICE_BUS_QUEUE_NAME=${SERVICE_BUS_QUEUE_NAME:-"sbq-fabrikam-containerapp"}
CONTAINER_APP_ENVIRONMENT=${CONTAINER_APP_ENVIRONMENT:-"cae-fabrikam-containerapp"}
LOG_ANALYTICS_WORKSPACE_NAME=${LOG_ANALYTICS_WORKSPACE_NAME:-"log-fabrikam-containerapp"}

DEPLOYMENT_NAME=${DEPLOYMENT_NAME:-"fabrikam-containerapp-main-deployment"}
CONTAINER_APP_DEPLOYMENT_NAME=${CONTAINER_APP_DEPLOYMENT_NAME:-"fabrikam-containerapp-containerapp-deployment"}

IMAGE_NAME=${IMAGE_NAME:-"fabrikam-containerapp-example"}
